...
fn cycleOfAcceptance(clientsMAL: *serverTypes.ClientsMAL, listenSocket: posix.socket_t) !u32 {
...
fn cycleOfServing(clientsMAL: *serverTypes.ClientsMAL, listenSocket: posix.socket_t) !void {
    var connectionsHandled: u32 = 0;
...
pub fn main() serverTypes.VSEError!void {
    ...
    log.debug(
        "Initialized clients multi array list with size {} bytes",
    ...
    try cycleOfServing(&clientsMAL, listenSocket);
}
